...
export function createSocket(iface) { return new Socket(iface); }

export const EFF_FLAG = 0x80000000; // extended frame format
export const RTR_FLAG = 0x40000000; // remote transmission request
export const ERR_FLAG = 0x20000000; // error

export const SFF_MASK = 0x7FF; // standard frame format - 11 bits
export const EFF_MASK = 0x1FFFFFFF; // extended frame format - 29 bits
export const ERR_MASK = 0x1FFFFFFF;
